package com.fmall.springmvc.action;
...
import com.fmall.springmvc.javabean.Demo;
import com.fmall.springmvc.service.IDemoService;
import com.fmall.springmvc.validator.DemoValidator;
 ...
 * 一、如何注册controller 
 * 1:在类前加上Controller标签 
 * 2.在配置文件里	<mvc:annotation-driven/>
