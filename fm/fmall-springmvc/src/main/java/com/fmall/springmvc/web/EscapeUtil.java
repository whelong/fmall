package com.fmall.springmvc.web;
...
public class EscapeUtil{
	public static Object escapeStringFiledsToHTMLCode(Object obj){
		...
		for(Field field : fields){
			...
			if(String.class.equals(field.getType())){
				...
				escapeStringFiledsToHTMLCode(ReflectionUtils.getField(field, obj));
			}
		}	
		return obj;
	}
	...
	public static Object escapeMap(Object obj){
		...
		if(obj instanceof Map){
			...
			while(entries.iterator().hasNext()){
				escapeStringFiledsToHTMLCode(((Entry) entries.iterator().next()).getValue());
			}
	...
	public static void main(String[] args){
		...
		System.out.println("hotel message:"+escapehotel.getName()+"---"+escapehotel.getPropertyCode());
